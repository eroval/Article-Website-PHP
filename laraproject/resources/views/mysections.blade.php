        ...
        @section('mycontent')
            <div class="my_content" style="display: flex; min-height:800px; min-width:550px; width: 100%; height: 80%; font-family: 'Cormorant Garamond'; ">
                <div class="container-fluid">
                    @section('hbtn')
                        @if (Auth::check())
                        <!-- <div class="d-flex flex-row-reverse"> -->
                            <div class="hand-button"  style="margin-left:15px; margin-right:15px; margin-top: 30px; ">
        ...
        @section('article-creator')
            <div class="my_content" style="min-height: 800px; display: flex; min-width:550px; width: 100%; height: 80%; font-family: 'Cormorant Garamond'; ">
                <div class="container-fluid">  
                    <div class="card-body">
        ...
        @section('article-creator-error')
            <div class="my_content" style="min-height: 800px; min-width:500px; display: flex; width: 100%; height: 80%; font-family: 'Cormorant Garamond'; ">
